...
export const serviceOptions: ServiceOption[] = [
  ...
  },
  {
    id: 'lease',
    name: 'Solar Lease',
    description: '$0 upfront cost with fixed monthly payments, typically offering a 25% discount to your current electricity bill. Maintenance included for 20-25 years.',
    upfrontCost: '$0',
  ...
  },
  {
    ...
    description: '$0 upfront cost. Pay only for the electricity generated by your solar system at rates lower than utility prices. O&M included for 20-25 years with annual escalation up to 2%.',
    upfrontCost: '$0',
    termLength: '20-25 years',
    taxBenefits: false,
    maintenanceIncluded: true,
